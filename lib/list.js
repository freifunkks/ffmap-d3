...
define("list", [
  ...
  function nodetable(table, fn) {
    ...
    function prepare() {
      ...
      tr.append("th").text("B.A.T.M.A.N")
      tr.append("th").text("Gateway")
    ...
    function update(data) {
      ...
      row.append("td").text(function (d) { return d.gateway })
      row.append("td").text(function (d) { return parseInt(d.uptime / 3600) + "h" })
