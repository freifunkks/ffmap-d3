...
define("list", [
  ...
  function nodetable(table, fn) {
    ...
    function update(data) {
      ...
      foot.append("td").attr("colspan", 4).style("text-align", "right").text("Zuletzt aktualisiert: " + (new Date(data.meta.timestamp + "Z")).toUTCString())
  ...
  function gwtable(table, fn) {
    ...
    function update(data) {
      ...
      foot.append("td").attr("colspan", 3).style("text-align", "right").text("Zuletzt aktualisiert: " + (new Date(data.meta.timestamp + "Z")).toUTCString())
