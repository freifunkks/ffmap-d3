define("graph", [
  ...
  function reload(json) {
    ...
    var nNodes = data.nodes.filter(function(d) {
                   return d.role !== "gateway" && d.role !== "service" && d.role !== "backbone" && d.flags.online
                 }).length,
        nAllNodes = data.nodes.filter(function(d) {
                   return d.role !== "gateway" && d.role !== "service" && d.role !== "backbone"
                 }).length,
        nServices = data.nodes.filter(function(d) {
                   return d.role === "service" && d.flags.online
                 }).length,
        nBackbones = data.nodes.filter(function(d) {
                   return d.role === "backbone" && d.flags.online
                 }).length,
  ...
  function update() {
    ...
    node.attr("class", function(d) {
          var s = ["node"]
          if (d.role !== "gateway" && d.role !== "service")
            if (data.meta.gluon_release > d.firmware)
              s.push(["legacy"])
